...
# Project:  file.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -o Makefile file.pro
#############################################################################
...
CXXFLAGS      += -Wlong-long -w -pedantic -Wsign-compare  -fpermissive -Wempty-body -Wunused-variable -Wunused-but-set-variable
INCPATH       = -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++ -I. -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lQt5Widgets -L/usr/lib/i386-linux-gnu -lQt5Network -lQt5Gui -lQt5Core -lGL -lpthread -lsfml-graphics -lsfml-window -lsfml-system -lGL -lGLU -lglut
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		carte.cpp \
		Qtexplorateur.cpp moc_Qtexplorateur.cpp\
		vector3d.cpp\
		FreeFlyCamera.cpp
...
Makefile: file.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/file1.0.0 || mkdir -p .tmp/file1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/file1.0.0/ && $(COPY_FILE) --parents carte.h Qtexplorateur.h .tmp/file1.0.0/ && $(COPY_FILE) --parents main.cpp carte.cpp Qtexplorateur.cpp .tmp/file1.0.0/ && (cd `dirname .tmp/file1.0.0` && $(TAR) file1.0.0.tar file1.0.0 && $(COMPRESS) file1.0.0.tar) && $(MOVE) `dirname .tmp/file1.0.0`/file1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/file1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_Qtexplorateur.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Qtexplorateur.cpp
moc_Qtexplorateur.cpp: /usr/include/qt5/QtWidgets/QApplication \
...
FreeFlyCamera.o: FreeFlyCamera.cpp FreeFlyCamera.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o FreeFlyCamera.o FreeFlyCamera.cpp

vector3d.o: vector3d.cpp vector3d.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o vector3d.o vector3d.cpp

Qtexplorateur.o: Qtexplorateur.cpp Qtexplorateur.h \
		/usr/include/qt5/QtWidgets/QApplication \
		/usr/include/qt5/QtWidgets/qapplication.h \
		/usr/include/qt5/QtCore/qcoreapplication.h \
		/usr/include/qt5/QtCore/qglobal.h \
		...
		/usr/include/qt5/QtWidgets/qmessagebox.h \
		/usr/include/qt5/QtWidgets/qdialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Qtexplorateur.o Qtexplorateur.cpp

moc_Qtexplorateur.o: moc_Qtexplorateur.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_Qtexplorateur.o moc_Qtexplorateur.cpp
